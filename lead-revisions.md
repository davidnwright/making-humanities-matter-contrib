Thinking about revisions to the MHM Piece:
...
So are you advocating for a politics of (re)fabrication? Is it fabrication or re-fabrication?
...
* Generally speaking, I read this draft as a direct response to Elliott et al.'s work. Would it help to make that engagement more explicit? For instance, I get the impression that "we" (including its use in the first paragraph) frequently means "Elliott et al." What if the chapter were revised to be more of a dialogue with "New Old Things"? Would such a gesture help you ground the 2500 words?
* From my perspective, the chapter may need to explain why fabrication is historically unique. Otherwise, perhaps fabrication is given too much credit or weight?
* At times, the structure of the writing is somewhat repetitive (e.g., "When we VERB"). 
* While reading, I found the paragraph starting with "The 3D printed object..." quite vague. 
* I'd cut the gratuitous reference to Auschwitz.
* When describing the printing process, you suggest that "The process begins by loading..." But doesn't the process begin with creating the model or digitizing an object? Or are you purposefully privileging the consumer / end-user position?
* I also think the altar needs A LOT more context. Perhaps the entire chapter could be anchored in a particular object? I know that's a substantial revision, tho.
* While reading, I got the feeling that, ultimately, any technology could do this: "fabricating connections between materiality and memory." Know what I mean? Again, what makes digital fabrication unique?
* I frequently felt as if the references to "truth" were rather lofty and unsubstantiated.
* All that said, I found the emphasis on the ethics of reanimating ghosts, or of triggering traumatic events, compelling. I'd be interested in hearing more about how 3D models + fabrications reanimate and trigger differently than other media, and how the performative or experiential character of the past is entangled with situation (or the present).
